  ...
  static show(
    ...
    void _redeemHandler() async {
      ...
      int redeemRewardPoint = (double.parse(_controller.text) /
              double.parse(_rewardPointProvider!.rewardPointState.rewardPointData![Environment.rootStoreId]["redeem"]["rewardPoints"].toString()) *
              double.parse(_rewardPointProvider!.rewardPointState.rewardPointData![Environment.rootStoreId]["redeem"]["rewardPoints"].toString()))
          .toInt();

      int redeemValue = (double.parse(_controller.text) /
              double.parse(_rewardPointProvider!.rewardPointState.rewardPointData![Environment.rootStoreId]["redeem"]["rewardPoints"].toString()) *
              double.parse(_rewardPointProvider!.rewardPointState.rewardPointData![Environment.rootStoreId]["redeem"]["value"].toString()))
          .toInt();
                        ...
                        Container(
                          ...
                          child: TextFormField(
                            ...
                            validator: (input) {
                              ...
                              if (remaining != 0.0) {
                                return "Please enter multiples of ${rewardPointProvider.rewardPointState.rewardPointData![Environment.rootStoreId]["redeem"]["rewardPoints"]}";
                              }
