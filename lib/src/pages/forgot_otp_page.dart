...
class ForgotOTPPage extends StatefulWidget {
  ...
  ForgotOTPPage({@required this.identity, this.callback});
                ...
                Positioned(
                  ...
                  child: Column(
                    children: [
                      ...
                      SizedBox(height: heightDp1 * 20),
                      Text(
                        S.of(context).forgot_otp_page_title,
                      ...
                      Container(
                        ...
                        child: Form(
                          ...
                          child: Column(
                            ...
                            children: <Widget>[
                              Text(
                                "OTP has been sent to ${widget.identity}.\nPlease check and enter accordingly.",
