...
class StoreRewardPointWidget extends StatefulWidget {
  final Map<String, dynamic>? referralRewardData;
  final bool isLoading;
  final Function()? tapCallback;

  StoreRewardPointWidget({
  ...
  @override
  _StoreRewardPointWidgetState createState() => _StoreRewardPointWidgetState();
}

class _StoreRewardPointWidgetState extends State<StoreRewardPointWidget> {
    ...
    return GestureDetector(
      ...
      child: Container(
        ...
        child: Row(
          children: [
            KeicyAvatarImage(
              url: widget.referralRewardData!["store"]["profile"]["image"],
              width: widthDp * 80,
              height: widthDp * 80,
            ...
            Expanded(
              child: Column(
                ...
                children: [
                  Text(
                    "${widget.referralRewardData!["store"]["name"]}",
                    style: TextStyle(fontSize: fontSp * 16, color: Colors.black, fontWeight: FontWeight.w700),
                    maxLines: 2,
                    overflow: TextOverflow.ellipsis,
                  ),
